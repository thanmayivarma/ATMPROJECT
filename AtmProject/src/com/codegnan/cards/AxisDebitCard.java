...
int chances;
public AxisDebitCard(long debitCardNumber, String name, double
accountBalance, int pinNumber) {
chances = 3;
this.name = name;
...
throw new InsufficientBalanceException("you don:t have sufficient balance to withdraw.. Please check your balanace");
} else {
...
@Override
public void decreaseChances() {--chances;
}
@Override
